...
export * from './brokerUser.service';
import { BrokerUserService } from './brokerUser.service';
...
export const APIS = [AuthService, BrokerImagesService, BrokerUserService, BrokersService, PermissionsService, RolePermissionsService, RoleUsersService, RolesService, TransactionsService, UserRolesService, UsersService];
